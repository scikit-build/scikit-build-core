...
def test_best_gen_unix():
    """Test best_gen() on Unix."""
    assert parse_help_default(UNIX_OUTPUT) == "Unix Makefiles"


def test_best_gen_windows():
    """Test best_gen() on Windows."""
    assert parse_help_default(WINDOWS_OUTPUT) == "Visual Studio 16 2019"
